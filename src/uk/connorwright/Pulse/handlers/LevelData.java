...
public class LevelData {
	...
	public static final String LEVEL9_1 = "impossible   1";
	...
	public static void init() {
		...
		try {
			SC_FONT = Font.createFont(Font.TRUETYPE_FONT,
	...
	public static int getTime() {
		...
		if (currentLevel.equals(LEVEL3_4))
			return 60 * 15;
		if (currentLevel.equals(LEVEL5_1))
			return 60 * 15;
		if (currentLevel.equals(LEVEL5_2))
			return 60 * 12;
		if (currentLevel.equals(LEVEL5_3))
			return 60 * 15;
		if (currentLevel.equals(LEVEL5_4))
			return 60 * 15;
		if (currentLevel.equals(LEVEL7_2))
			return 60 * 30;
		return -1;
